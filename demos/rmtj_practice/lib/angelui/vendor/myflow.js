...
(function ($) {
    ...
    myflow.rect = function (o, r) {
        ...
        this.toJson = function () {
            ...
            $(_o.props).each(function (index) {
                dataObj.props[index] = {value: this.value}
            });
        ...
        var textchangeHandler = function (e, v, src) {
            ...
            if (_autoText) {
                if (_to.getId() == src.getId()) {
                    //$('body').append('change!!!');
                    _text.attr({
                        text: _o.text.value.replace('{from}',
                    ...
                    //$('body').append('change!!!');
                    _text.attr({
                        text: _o.text.value.replace('{from}', v)
                            .replace('{to}', _to.text())
                    });
                }
            }
    ...
    myflow.init = function (c, o) {
        var _w = $(document).width(), _h = $(document).height(), _r = Raphael(c, _w, _h), _states = {}, _paths = {};
